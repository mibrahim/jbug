<div style="width:100%">
    <div class="fullwidthbar">
		...
		<input type="text" id="searchbar" name="searchbar" placeholder="SEARCH..."/> <a href="javascript:search()" class="btn btn-blue">&Gt;</a>
        <div style="float:right;">
            <a id="grv" href="javascript:getUserEmail();"></a>
            <a href="" class="btn btn-blue" title="Search"><i class="icon-search"></i></a>
        </div>
    </div>
</div>